...
$Main = {
    ...
    # Step 2: Fill study log gaps with zero-hour entries for days not studied
    Invoke-Step -Name 'Update-StudyLogGaps' -ScriptPath (Join-Path $ScriptsDir 'Update-StudyLogGaps.ps1')

    # Step 3: Update progress tracker day counts
    ...
    # Step 6: Collapse open detail blocks
