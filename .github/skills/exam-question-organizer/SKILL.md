...
Two additional optional metadata lines may follow: `**Answer Result:**` (values: `wrong`, `unsure`, `correct`) and `**ID:**` (7-character hex identifier). Missing Answer Result defaults to `unsure`; missing ID is auto-generated on write.
...
* **ID** — A stable 7-character hex identifier for cross-referencing. Auto-generated by the script when missing; existing IDs are preserved.
