...
| ----- | ------- | ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A** | **1–2** | 🧠 **Identity & Governance Foundations** | [Lab 1 – Setup and Identity Baseline](./labs/lab01-setup-identity-baseline/Lab01_Setup-Identity-Baseline.md) <br>[Lab 2 – RBAC and Scoping](./labs/lab02-rbac-scoping/Lab02_Role-Based-Access-Scoping.md) <br>[Lab 3 – Governance & Policies](./labs/lab03-governance-policies/Lab03_Governance-Policies.md) <br>Lab 4 – Subscription & Budgets |
...
| ------ | ---------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ----------------- | --------------- | --------------- |
| **1**  | [Setup and Identity Baseline](./labs/lab01-setup-identity-baseline/Lab01_Setup-Identity-Baseline.md) | Create users & groups, manage user/group properties, license management, external users, SSPR | None              | ✅ Complete | 10/9/25 - 10/20/25 <br> (11 days) |
| **2**  | [Role-Based Access & Scoping](./labs/lab02-rbac-scoping/Lab02_Role-Based-Access-Scoping.md)                                                                          | Built-in roles, assign roles by scope, interpret access assignments                           | Lab 1             | ✅ Complete | 10/20/25 - 10/29/25 (9 days) |
| **3**  | [Governance & Policies](./labs/lab03-governance-policies/Lab03_Governance-Policies.md)                                                                                | Policy definition/initiative, resource locks, tags, moving resources                          | Lab 2             | 🚧 In Progress | 10/29/2025 - |
