...
| ----- | ------- | ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A** | **1–2** | 🧠 **Identity & Governance Foundations** | [Lab 1 – Setup and Identity Baseline](./labs/lab01-setup-identity-baseline/Lab01_Setup-Identity-Baseline.md) <br>[Lab 2 – RBAC and Scoping](./labs/lab02-rbac-scoping/Lab02_Role-Based-Access-Scoping.md) <br>Lab 3 – Policy & Resource Locks <br>Lab 4 – Subscription & Budgets |
