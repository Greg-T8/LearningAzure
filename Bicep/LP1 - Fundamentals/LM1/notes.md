[Microsoft Learn - Build your first Bicep file](https://learn.microsoft.com/en-us/training/modules/build-first-bicep-file/)

<!-- omit in toc -->
# Learning Module 1: Build your first Bicep file
...
[appService.bicep](<./LP1 - Fundamentals/LM1/code/modules/appService.bicep>):
```bicep
