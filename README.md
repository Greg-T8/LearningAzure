...
| **Weekly Total** | **0.0h** | **21.5h** | **21.5h** |
| ***Running Total*** | ***60.5h*** | ***62.3h*** | ***122.8h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: August 18, 2026 at 04:58 CDT*
...
|------|-------------|--------|---------|-------------|-----------------|
| [**AZ‑305**](certs/AZ-305/README.md) | Azure Solutions Architect Expert | In Progress | 5/30/26 – 8/18/26 (81d) | 34 | 60.5h |
...
|-------|-------------|--------|---------|-------------|-----------------|
| [**ALZ**](applied-skills/ALZ/README.md) | Azure Landing Zone | In Progress | 7/17/26 – 8/18/26 (33d) | 30 | 60.0h |
