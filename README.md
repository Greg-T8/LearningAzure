...
| **Weekly Total** | **9.7h** | **8.0h** | **17.7h** |
| ***Running Total*** | ***45.1h*** | ***17.4h*** | ***62.5h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: July 30, 2026 at 08:37 CDT*
...
|------|-------------|--------|---------|-------------|-----------------|
| [**AZ‑305**](certs/AZ-305/README.md) | Azure Solutions Architect Expert | In Progress | 5/30/26 – 7/30/26 (62d) | 26 | 45.0h |
...
|-------|-------------|--------|---------|-------------|-----------------|
| [**ALZ**](applied-skills/ALZ/README.md) | Azure Landing Zone | In Progress | 7/17/26 – 7/30/26 (14d) | 13 | 15.0h |
