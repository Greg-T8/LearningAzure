...
|------|-------------|--------|---------|
| 🔷 [**SC-300**](certs/SC-300/README.md) | Microsoft Identity and Access Administrator | In Progress | 4/22/26 – 5/22/26 (30d) |
...
| **Weekly Total** | **13.0h** | **13.0h** |
| ***Running Total*** | ***68.2h*** | ***68.2h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: May 22, 2026 at 05:53 CDT*
