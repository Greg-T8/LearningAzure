...
| Fri, Jul 24 | 🟢 1.0h | 🟢 1.0h | **2.0h** |
| Thu, Jul 23 | 🟢 1.2h | 🟡 0.8h | **2.0h** |
| **Weekly Total** | **9.2h** | **7.8h** | **17.0h** |
| ***Running Total*** | ***43.4h*** | ***16.3h*** | ***59.7h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: July 29, 2026 at 06:41 CDT*
...
|------|-------------|--------|---------|-------------|-----------------|
| [**AZ‑305**](certs/AZ-305/README.md) | Azure Solutions Architect Expert | In Progress | 5/30/26 – 7/29/26 (61d) | 25 | 43.4h |
...
|-------|-------------|--------|---------|-------------|-----------------|
| [**ALZ**](applied-skills/ALZ/README.md) | Azure Landing Zone | In Progress | 7/17/26 – 7/29/26 (13d) | 12 | 14.0h |
