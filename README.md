...
|------|-------------|--------|---------|
| 🔷 [**SC-300**](certs/SC-300/README.md) | Microsoft Identity and Access Administrator | In Progress | 4/22/26 – 5/9/26 (17d) |
...
| Sun, May 03 |  |  |
| **Weekly Total** | **15.1h** | **15.1h** |
| ***Running Total*** | ***41.6h*** | ***41.6h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: May 09, 2026 at 08:34 CDT*
