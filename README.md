...
| **Weekly Total** | **0.0h** | **21.6h** | **21.6h** |
| ***Running Total*** | ***60.5h*** | ***57.5h*** | ***118.0h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: August 16, 2026 at 08:14 CDT*
...
|------|-------------|--------|---------|-------------|-----------------|
| [**AZ‑305**](certs/AZ-305/README.md) | Azure Solutions Architect Expert | In Progress | 5/30/26 – 8/16/26 (79d) | 34 | 60.5h |
...
|-------|-------------|--------|---------|-------------|-----------------|
| [**ALZ**](applied-skills/ALZ/README.md) | Azure Landing Zone | In Progress | 7/17/26 – 8/16/26 (31d) | 28 | 55.2h |
