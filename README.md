...
|------|-------------|--------|---------|
| 🔷 [**SC-300**](certs/SC-300/README.md) | Microsoft Identity and Access Administrator | In Progress | 4/22/26 – 5/14/26 (22d) |
...
| **Weekly Total** | **16.7h** | **16.7h** |
| ***Running Total*** | ***52.8h*** | ***52.8h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: May 14, 2026 at 06:02 CDT*
