...
| Sun, Sep 06 |  |  |  |
| Sat, Sep 05 |  |  |  |
| **Weekly Total** | **3.7h** | **2.1h** | **5.8h** |
| ***Running Total*** | ***64.2h*** | ***73.0h*** | ***137.2h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: September 11, 2026 at 06:07 CDT*
...
|------|-------------|--------|---------|-------------|-----------------|
| [**AZ‑305**](certs/AZ-305/README.md) | Azure Solutions Architect Expert | In Progress | 5/30/26 – 9/11/26 (105d) | 37 | 64.1h |
...
|-------|-------------|--------|---------|-------------|-----------------|
| [**ALZ**](applied-skills/ALZ/README.md) | Azure Landing Zone | In Progress | 7/17/26 – 9/11/26 (57d) | 35 | 70.7h |
