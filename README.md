...
| **Weekly Total** | **0.0h** | **25.0h** | **25.0h** |
| ***Running Total*** | ***60.5h*** | ***51.2h*** | ***111.7h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: August 14, 2026 at 08:22 CDT*
...
|------|-------------|--------|---------|-------------|-----------------|
| [**AZ‑305**](certs/AZ-305/README.md) | Azure Solutions Architect Expert | In Progress | 5/30/26 – 8/14/26 (77d) | 34 | 60.5h |
...
|-------|-------------|--------|---------|-------------|-----------------|
| [**ALZ**](applied-skills/ALZ/README.md) | Azure Landing Zone | In Progress | 7/17/26 – 8/14/26 (29d) | 27 | 48.9h |
