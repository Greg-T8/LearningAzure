...
|------|-------------|--------|---------|
| 🔷 [**AZ-305**](certs/AZ-305/README.md) | Azure Solutions Architect Expert | In Progress | 5/30/26 – 7/18/26 (50d, 28h) |
| 📕 [**SC-300**](certs/Inactive/SC-300/README.md) | Microsoft Identity and Access Administrator | Completed | 4/22/26 – 5/29/26 (37d, 84h) |
...
|-------|-------------|--------|---------|
| 🛠️ [**ALZ**](applied-skills/ALZ/README.md) | Azure Landing Zone | In Progress | 7/17/26 – 7/18/26 (2d, 5h) |
...
| Sun, Jul 12 | 🟢 1.8h |  | **1.8h** |
| **Weekly Total** | **10.7h** | **5.0h** | **15.7h** |
| ***Running Total*** | ***27.9h*** | ***5.0h*** | ***32.9h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: July 18, 2026 at 07:54 CDT*
