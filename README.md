...
|------|-------------|--------|---------|
| 🔷 [**SC-300**](certs/SC-300/README.md) | Microsoft Identity and Access Administrator | In Progress | 4/22/26 – 5/18/26 (26d) |
...
| **Weekly Total** | **15.6h** | **15.6h** |
| ***Running Total*** | ***62.1h*** | ***62.1h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: May 18, 2026 at 06:05 CDT*
