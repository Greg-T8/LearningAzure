...
|------|-------------|--------|---------|
| 🔷 [**SC-300**](certs/SC-300/README.md) | Microsoft Identity and Access Administrator | In Progress | 4/22/26 – 5/23/26 (31d) |
...
| **Weekly Total** | **12.3h** | **12.3h** |
| ***Running Total*** | ***70.0h*** | ***70.0h*** |

*Activity Levels: 🟡 Low (< 1hr) | 🟢 Medium (1-2hrs) | 🟣 High (> 2hrs)*

*Last updated: May 23, 2026 at 08:34 CDT*
