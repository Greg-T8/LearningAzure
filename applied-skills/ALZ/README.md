...
<!-- STUDY_SUMMARY -->
**Hours Committed:** 45.2h · **Days Studied:** 26
<!-- /STUDY_SUMMARY -->
...
- ALZ concepts, management-group hierarchy, policy, and platform subscriptions.
- ALZ Terraform Accelerator planning, prerequisites, bootstrap, and deployment flow.
- The `platform_landing_zone` template and Azure Verified Module responsibilities.
- Safe Terraform planning, deployment, and validation approaches.
