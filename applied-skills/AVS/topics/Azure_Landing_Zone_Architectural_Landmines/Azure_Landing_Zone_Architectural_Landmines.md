...
![Azure Lighthouse delegation from a service-provider tenant to customer subscriptions and resource groups](images/azure-lighthouse-delegated-resource-management.jpg)
*Source: [Microsoft Learn — Azure Lighthouse architecture](https://learn.microsoft.com/en-us/azure/lighthouse/concepts/architecture)*
...
![Privileged Identity Management pane for activating an eligible Azure resource role with a defined duration and justification](images/pim-azure-role-activation.png)
*Source: [Microsoft Learn — Activate my Azure resource roles in Privileged Identity Management](https://learn.microsoft.com/en-us/entra/id-governance/privileged-identity-management/pim-resource-roles-activate-your-roles)*
...
![Azure landing zone management-group hierarchy showing platform, landing-zone, decommissioned, and sandbox branches with their subscriptions](images/azure-landing-zone-management-group-hierarchy.png)
*Source: [Microsoft Learn — Management groups](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/landing-zone/design-area/resource-org-management-groups)*
...
![Subscription vending process across the application team, Cloud Center of Excellence, and platform team](images/subscription-vending-process.png)
*Source: [Microsoft Learn — Subscription vending](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/ready/landing-zone/design-area/subscription-vending)*
...
![Azure hub-and-spoke topology with centralized firewall, VPN gateway, Bastion, monitoring, and production and non-production spoke virtual networks](images/hub-spoke-architecture.png)
*Source: [Microsoft Learn — Hub and spoke deployment](https://learn.microsoft.com/en-us/samples/mspnp/samples/hub-and-spoke-deployment/)*
...
![Application security groups organizing web, logic, and database virtual-machine network interfaces for reusable NSG rules](images/application-security-groups.png)
*Source: [Microsoft Learn — Application security groups](https://learn.microsoft.com/en-us/azure/virtual-network/application-security-groups)*
...
![Explicit Azure outbound connectivity options using a public IP, load balancer outbound rules, or NAT Gateway](images/explicit-outbound-options.png)
*Source: [Microsoft Learn — Default outbound access in Azure](https://learn.microsoft.com/en-us/azure/virtual-network/ip-services/default-outbound-access)*
