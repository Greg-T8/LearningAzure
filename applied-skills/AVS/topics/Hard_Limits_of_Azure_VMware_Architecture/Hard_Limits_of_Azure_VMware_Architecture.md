...
![Azure VMware Solution hub-and-spoke connectivity through ExpressRoute Global Reach](images/azure-vmware-solution-hub-and-spoke-deployment.png)
...
![Azure Network Watcher Connection Monitor architecture for Azure and hybrid endpoints](images/connection-monitor-hybrid-endpoints.png)

*Source: [Microsoft Learn — Connection monitor overview](https://learn.microsoft.com/en-us/azure/network-watcher/connection-monitor-overview)*
...
![Azure NetApp Files datastore connectivity for Azure VMware Solution Generation 1](images/azure-netapp-files-datastore-generation-1.png)
...
![Modernized Azure Site Recovery architecture for VMware workloads](images/azure-site-recovery-modernized-architecture.png)

*Source: [Microsoft Learn — VMware to Azure disaster recovery architecture — Modernized](https://learn.microsoft.com/en-us/azure/site-recovery/vmware-azure-architecture-modernized)*
...
![vSAN stretched cluster across two availability zones with a managed witness in a third zone](images/vsan-stretched-cluster-three-availability-zones.png)

*Source: [Microsoft Learn — Design considerations for vSAN stretched clusters](https://learn.microsoft.com/en-us/azure/azure-vmware/architecture-stretched-clusters)*
...
![HCX Mobility Optimized Networking path compared with trombone routing](images/hcx-mobility-optimized-networking-traffic-path.png)

*Source: [Microsoft Learn — VMware HCX Mobility Optimized Networking guidance](https://learn.microsoft.com/en-us/azure/azure-vmware/vmware-hcx-mon-guidance)*
