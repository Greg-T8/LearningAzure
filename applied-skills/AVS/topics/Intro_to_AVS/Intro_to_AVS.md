...
![Azure VMware Solution private cloud components and related Azure connectivity services](images/avs-private-cloud-components.png)

*Source: [Microsoft Learn — Architecture for Private Clouds and Clusters](https://learn.microsoft.com/en-us/azure/azure-vmware/architecture-private-clouds)*
...
![Azure VMware Solution mixed-SKU topology with an AV64 expansion cluster](images/av64-mixed-sku-topology.png)

*Source: [Microsoft Learn — What is Azure VMware Solution?](https://learn.microsoft.com/en-us/azure/azure-vmware/introduction)*
...
![AV64 host distribution across vSAN fault domains before a host-removal operation](images/av64-fault-domain-host-removal.png)
...
![Azure NetApp Files NFS datastore connectivity to an Azure VMware Solution Generation 1 private cloud](images/azure-netapp-files-gen1-datastore-architecture.png)
...
![Generation 1 Azure VMware Solution management network and reserved address block](images/gen1-management-network-subdivision.png)

*Source: [Microsoft Learn — Plan the Azure VMware Solution deployment](https://learn.microsoft.com/en-us/azure/azure-vmware/plan-private-cloud-deployment)*
...
![Azure VMware Solution Generation 2 private cloud connected directly to an Azure virtual network](images/gen2-vnet-connectivity.png)
...
![ExpressRoute Global Reach connectivity between an on-premises environment and Azure VMware Solution](images/expressroute-global-reach-connectivity.png)
...
![Azure VMware Solution integrated into a secured Azure hub-and-spoke network](images/avs-hub-spoke-architecture.png)
...
![Azure VMware Solution shared responsibility matrix](images/avs-shared-responsibility-matrix.png)
...
![VMware HCX architecture connecting an on-premises source environment to Azure VMware Solution](images/hcx-migration-architecture.png)

*Source: [Microsoft Learn — VMware HCX migration considerations](https://learn.microsoft.com/en-us/azure/azure-vmware/architecture-migrate)*
...
![HCX Mobility Optimized Networking routing traffic locally after workload migration](images/hcx-mon-optimized-routing.png)
...
![vSAN stretched cluster across two availability zones with a managed witness in a third zone](images/vsan-stretched-cluster-witness.png)
