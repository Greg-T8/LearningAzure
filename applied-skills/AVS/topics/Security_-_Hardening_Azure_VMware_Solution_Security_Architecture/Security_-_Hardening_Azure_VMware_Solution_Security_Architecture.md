...
![Azure VMware Solution architectural components](images/avs-private-cloud-architecture.png)
...
![VMware NSX connectivity to an external LDAP identity source](images/nsx-ldap-identity-connectivity.png)

*Source: [Microsoft Learn — Set an external identity source for VMware NSX](https://learn.microsoft.com/en-us/azure/azure-vmware/configure-external-identity-source-nsx-t)*
...
![HCX interface for creating a network extension](images/hcx-create-network-extension.png)

*Source: [Microsoft Learn — Create an HCX network extension](https://learn.microsoft.com/en-us/azure/azure-vmware/configure-hcx-network-extension)*
...
![ExpressRoute Global Reach topology connecting an on-premises VMware environment to Azure VMware Solution](images/expressroute-global-reach-topology.png)
...
![Azure Firewall Premium TLS inspection flow](images/azure-firewall-premium-tls-inspection.png)

*Source: [Microsoft Learn — Azure Firewall Premium features implementation guide](https://learn.microsoft.com/en-us/azure/firewall/premium-features#tls-inspection)*
...
![Application Gateway publishing web applications hosted in Azure VMware Solution](images/application-gateway-avs-topology.png)

*Source: [Microsoft Learn — Protect web apps on Azure VMware Solution with Azure Application Gateway](https://learn.microsoft.com/en-us/azure/azure-vmware/protect-azure-vmware-solution-with-application-gateway#topology)*
...
![Azure Monitor Agent data collection through data collection rules](images/azure-monitor-agent-data-collection.png)

*Source: [Microsoft Learn — Data collection rules (DCRs) in Azure Monitor](https://learn.microsoft.com/en-us/azure/azure-monitor/data-collection/data-collection-rule-overview#azure-monitor-agent-ama)*
...
![Azure VMware Solution customer-managed key topology using Azure Key Vault and Microsoft Entra ID](images/avs-customer-managed-key-topology.png)

*Source: [Microsoft Learn — Configure customer-managed key encryption at rest in Azure VMware Solution](https://learn.microsoft.com/en-us/azure/azure-vmware/configure-customer-managed-keys#topology)*
...
![Trusted Launch components for Azure VMware Solution virtual machines](images/avs-trusted-launch-components.png)

*Source: [Microsoft Learn — Trusted Launch for Azure VMware Solution](https://learn.microsoft.com/en-us/azure/azure-vmware/configure-virtual-trusted-platform-module)*
...
![vSphere interface for adding a virtual Trusted Platform Module to an Azure VMware Solution virtual machine](images/enable-vtpm-on-avs-virtual-machine.png)

*Source: [Microsoft Learn — Trusted Launch for Azure VMware Solution](https://learn.microsoft.com/en-us/azure/azure-vmware/configure-virtual-trusted-platform-module#how-to-configure-vtpm)*
