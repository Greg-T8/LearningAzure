...
![Azure VMware Solution private cloud architectural components](images/avs-private-cloud-architecture.png)
...
![Azure NetApp Files datastore architecture for an Azure VMware Solution Generation 1 private cloud](images/avs-netapp-files-gen1-architecture.png)
...
![Azure VMware Solution Generation 2 virtual network connectivity](images/avs-gen2-virtual-network-connectivity.png)
...
![ExpressRoute Global Reach connectivity between on-premises and Azure VMware Solution](images/avs-expressroute-global-reach.png)

*Source: [Microsoft Learn — Peer on-premises environments to Azure VMware Solution](https://learn.microsoft.com/en-us/azure/azure-vmware/tutorial-expressroute-global-reach-private-cloud)*
...
![Azure VMware Solution vCenter Server connectivity to an Active Directory LDAP server](images/avs-vcenter-ldaps-connectivity.png)

*Source: [Microsoft Learn — Set an external identity source for vCenter Server](https://learn.microsoft.com/en-us/azure/azure-vmware/configure-identity-source-vcenter)*
...
![HCX Mobility Optimized Networking traffic optimization for stretched networks](images/avs-hcx-mon-traffic-optimization.png)
...
![JetStream disaster recovery between Azure VMware Solution private clouds](images/avs-jetstream-cloud-to-cloud-dr.png)

*Source: [Microsoft Learn — Deploy disaster recovery using JetStream DR software](https://learn.microsoft.com/en-us/azure/azure-vmware/deploy-disaster-recovery-using-jetstream)*
...
![Azure VMware Solution stretched cluster across two availability zones with a witness in a third zone](images/avs-stretched-cluster-witness.png)
...
![Azure Arc-enabled VMware vSphere architecture](images/azure-arc-enabled-vmware-architecture.png)
...
![Integrated security monitoring architecture for Azure VMware Solution virtual machines](images/avs-defender-security-monitoring.png)

*Source: [Microsoft Learn — Integrate Microsoft Defender for Cloud with Azure VMware Solution](https://learn.microsoft.com/en-us/azure/azure-vmware/azure-security-integration)*
...
| ---------- | ----------- | ---------------------------- | ------------------ | ----------------------- | ---------------- |
| `images/avs-private-cloud-architecture.png` | Azure subscription, private clouds, clusters, VMware components, connectivity, storage, migration, and disaster recovery relationships. | [Microsoft Learn — Azure VMware Solution private cloud and cluster concepts](https://learn.microsoft.com/en-us/azure/azure-vmware/architecture-private-clouds) | <https://learn.microsoft.com/en-us/azure/azure-vmware/media/concepts/hosts-clusters-private-clouds-final.png> | 2. AVS Service Model and Core Architecture | <https://learn.microsoft.com/en-us/azure/azure-vmware/architecture-private-clouds> |
| `images/avs-gen2-virtual-network-connectivity.png` | Generation 2 private cloud deployment inside an Azure virtual network with peering and on-premises connectivity. | [Microsoft Learn — Introduction to Azure VMware Solution Generation 2 Private Clouds](https://learn.microsoft.com/en-us/azure/azure-vmware/native-introduction) | <https://learn.microsoft.com/en-us/azure/azure-vmware/media/native-connectivity/azure-virtual-network-connectivity.png> | 7. Network Foundation and IP Addressing | <https://learn.microsoft.com/en-us/azure/azure-vmware/native-introduction> |
| `images/avs-netapp-files-gen1-architecture.png` | Azure NetApp Files NFS datastore connectivity to a Generation 1 private cloud through ExpressRoute. | [Microsoft Learn — Attach Azure NetApp Files datastores to Azure VMware Solution hosts](https://learn.microsoft.com/en-us/azure/azure-vmware/attach-azure-netapp-files-to-azure-vmware-solution-hosts) | <https://learn.microsoft.com/en-us/azure/azure-vmware/media/attach-netapp-files-to-cloud/architecture-netapp-files-generation-one.png> | 6. vSAN Storage Design and Capacity Constraints — External Storage Options | <https://learn.microsoft.com/en-us/azure/azure-vmware/attach-azure-netapp-files-to-azure-vmware-solution-hosts> |
| `images/avs-expressroute-global-reach.png` | ExpressRoute Global Reach path between customer premises, the AVS private-cloud circuit, and Azure virtual networks. | [Microsoft Learn — Peer on-premises environments to Azure VMware Solution](https://learn.microsoft.com/en-us/azure/azure-vmware/tutorial-expressroute-global-reach-private-cloud) | <https://learn.microsoft.com/en-us/azure/azure-vmware/media/pre-deployment/azure-vmware-solution-on-premises-diagram.png> | 8. ExpressRoute, Global Reach, and BGP Routing | <https://learn.microsoft.com/en-us/azure/azure-vmware/tutorial-expressroute-global-reach-private-cloud> |
| `images/avs-vcenter-ldaps-connectivity.png` | vCenter Server communication path to an Active Directory LDAP/LDAPS server through Azure networking. | [Microsoft Learn — Set an external identity source for vCenter Server](https://learn.microsoft.com/en-us/azure/azure-vmware/configure-identity-source-vcenter) | <https://learn.microsoft.com/en-us/azure/azure-vmware/media/nsxt/azure-vmware-solution-to-ldap-server.png> | 10. Identity, Access Control, and Break-Glass Design — LDAPS and Named Accounts | <https://learn.microsoft.com/en-us/azure/azure-vmware/configure-identity-source-vcenter> |
| `images/avs-hcx-mon-traffic-optimization.png` | HCX Network Extension and MON traffic paths showing local routing versus network tromboning. | [Microsoft Learn — VMware HCX Mobility Optimized Networking (MON) guidance](https://learn.microsoft.com/en-us/azure/azure-vmware/vmware-hcx-mon-guidance) | <https://learn.microsoft.com/en-us/azure/azure-vmware/media/tutorial-vmware-hcx/hcx-mon-user-case-diagram-1.png> | 12. HCX Migration Design — Mobility Optimized Networking | <https://learn.microsoft.com/en-us/azure/azure-vmware/configure-vmware-hcx> |
| `images/avs-jetstream-cloud-to-cloud-dr.png` | JetStream replication between AVS private clouds in separate regions using Azure Blob Storage. | [Microsoft Learn — Deploy disaster recovery using JetStream DR software](https://learn.microsoft.com/en-us/azure/azure-vmware/deploy-disaster-recovery-using-jetstream) | <https://learn.microsoft.com/en-us/azure/azure-vmware/media/jetstream-disaster-recovery/jetstream-cloud-to-cloud-diagram.png> | 14. Backup and Disaster Recovery — Disaster Recovery Options | <https://learn.microsoft.com/en-us/azure/azure-vmware/deploy-disaster-recovery-using-jetstream> |
| `images/avs-stretched-cluster-witness.png` | Stretched vSAN cluster across two availability zones with a Microsoft-managed witness in a third zone. | [Microsoft Learn — Design vSAN stretched clusters](https://learn.microsoft.com/en-us/azure/azure-vmware/architecture-stretched-clusters) | <https://learn.microsoft.com/en-us/azure/azure-vmware/media/stretch-clusters/diagram-1-vsan-witness-third-availability-zone.png> | 15. Stretched Clusters and vSAN Witness Behavior | <https://learn.microsoft.com/en-us/azure/azure-vmware/architecture-stretched-clusters> |
| `images/azure-arc-enabled-vmware-architecture.png` | Azure Arc resource bridge, vCenter inventory, guest management, Azure services, and governance relationships. | [Microsoft Learn — What is Azure Arc-enabled VMware vSphere?](https://learn.microsoft.com/en-us/azure/azure-arc/vmware-vsphere/overview) | <https://learn.microsoft.com/en-us/azure/azure-arc/vmware-vsphere/media/overview/architecture.png> | 17. Day-Two Operations and Lifecycle Management — Azure Arc, Defender, and VMware Security Tools | <https://learn.microsoft.com/en-us/azure/azure-arc/vmware-vsphere/overview> |
| `images/avs-defender-security-monitoring.png` | Security monitoring flow from AVS and on-premises VMs through Log Analytics, Defender for Cloud, and Microsoft Sentinel. | [Microsoft Learn — Integrate Microsoft Defender for Cloud with Azure VMware Solution](https://learn.microsoft.com/en-us/azure/azure-vmware/azure-security-integration) | <https://learn.microsoft.com/en-us/azure/azure-vmware/media/azure-security-integration/azure-integrated-security-architecture.png> | 17. Day-Two Operations and Lifecycle Management — Azure Arc, Defender, and VMware Security Tools | <https://learn.microsoft.com/en-us/azure/azure-vmware/azure-security-integration> |
