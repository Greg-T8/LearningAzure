...
- [AzureNamingTool](https://github.com/Azure/AzureNamingTool/wiki)
- Azure VMware Solution
- [Terraform Community Module for Cost Alert](https://registry.terraform.io/modules/CloudNationHQ/costs/azure/latest)
- [FinOps Toolkit - Microsoft Learn](https://learn.microsoft.com/en-us/cloud-computing/finops/toolkit/finops-toolkit-overviw)
