...
| 2 | Plan & Manage | Set up AI solutions in Foundry | 4 | ⏳ 3.0h | 🔲 | 🔲 | 🔲 | 🔲 | 3.0h | ⏳ 4/2/26 → _ · 26d |
| 3 | Plan & Manage | Manage, monitor, and secure AI systems | 4 | 🔲 | 🔲 | 🔲 | 🔲 | 🔲 | 0.0h | 🔲 |
| 4 | Plan & Manage | Implement responsible AI across generative AI and agentic systems | 4 | ⏳ 0.9h | 🔲 | 🔲 | 🔲 | 🔲 | 0.9h | ⏳ 4/21/26 → _ · 7d |
| 5 | Generative AI & Agentic | Build generative applications by using Foundry | 6 | ⏳ 5.5h | 🔲 | 🔲 | 🔲 | 🔲 | 5.5h | ⏳ 4/8/26 → _ · 20d |
| 6 | Generative AI & Agentic | Build agents by using Foundry | 6 | 🔲 | 🔲 | 🔲 | 🔲 | 🔲 | 0.0h | 🔲 |
| 7 | Generative AI & Agentic | Optimize and operationalize generative AI systems | 4 | ⏳ 1.9h | 🔲 | 🔲 | 🔲 | 🔲 | 1.9h | ⏳ 4/17/26 → _ · 11d |
