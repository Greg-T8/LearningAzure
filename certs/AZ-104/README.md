...
| Skill | Task | Qs | Labs |
| :--- | :--- | -: | -: |
| Configure access to storage (5 tasks) | Configure Azure Storage firewalls and virtual networks | 2 | 0 |
...
| Create and configure Azure App Service (8 tasks) | Provision an App Service plan | 6 | 1 |
