...
<!-- STUDY_SUMMARY -->
**Hours Committed:** 36.1h · **Days Studied:** 15
<!-- /STUDY_SUMMARY -->
...
| -: | :----- | :---- | :--- | -: |
| 1 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Test and troubleshoot Conditional Access policies | 2 |
| 2 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Implement session management | 2 |
| 3 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Implement device-enforced restrictions | 2 |
| 4 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Implement continuous access evaluation | 2 |
| 5 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Configure authentication context | 2 |
| 6 | Implement authentication and access management | Manage risk by using Microsoft Entra ID Protection | Monitor, investigate, and remediate risky workload identities | 2 |
| 7 | Plan and implement workload identities | Plan and implement identities for applications and Azure workloads | Create managed identities | 2 |
| 8 | Plan and implement workload identities | Plan and implement identities for applications and Azure workloads | Use a managed identity assigned to an Azure resource to access other Azure resources | 2 |
| 9 | Plan and implement workload identities | Plan, implement, and monitor the integration of enterprise applications | Design and implement integration for software as a service (SaaS) apps | 2 |
| 10 | Plan and implement workload identities | Plan, implement, and monitor the integration of enterprise applications | Assign, classify, and manage users, groups, and app roles for enterprise applications | 2 |
...
| 6 | Authentication & Access Management | Plan, implement, and manage Microsoft Entra Conditional Access | 10 | ⏳ 1.8h | 🔲 | 1.8h | ⏳ |
