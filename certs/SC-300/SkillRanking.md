# Skill Ranking — SC-300

Self-assessed skill rating for each task. Edit the **Rank** column only.

**Scale:** `1` no knowledge · `2` aware · `3` working knowledge · `4` proficient · `5` expert · *(blank = not yet assessed)*

> The Focus List in [README.md](./README.md) is generated from this file by `.assets/scripts/Update-FocusList.ps1`. Blank ranks sort first (highest priority).
...
| 6 | Implement and manage user identities | Configure and manage a Microsoft Entra tenant | Configure Company branding settings | 5 |
| 7 | Implement and manage user identities | Configure and manage a Microsoft Entra tenant | Configure tenant properties, user settings, group settings, and device settings | 4 |
...
| 16 | Implement and manage user identities | Implement and manage identities for external users and tenants | Manage external user accounts in Microsoft Entra ID | 4 |
...
| 35 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Plan Conditional Access policies | 4 |
| 36 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Implement Conditional Access policy assignments | 4 |
| 37 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Implement Conditional Access policy controls | 4 |
| 38 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Test and troubleshoot Conditional Access policies | 5 |
| 39 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Implement session management | 5 |
| 40 | Implement authentication and access management | Plan, implement, and manage Microsoft Entra Conditional Access | Implement device-enforced restrictions | 5 |
...
| 73 | Plan and implement workload identities | Manage and monitor app access by using Microsoft Defender for Cloud Apps | Configure Conditional Access app control | 5 |
| 74 | Plan and implement workload identities | Manage and monitor app access by using Microsoft Defender for Cloud Apps | Create access and session policies in Defender for Cloud Apps | 5 |
| 75 | Plan and implement workload identities | Manage and monitor app access by using Microsoft Defender for Cloud Apps | Implement and manage policies for OAuth apps | 5 |
| 76 | Plan and implement workload identities | Manage and monitor app access by using Microsoft Defender for Cloud Apps | Manage the Cloud app catalog | 5 |
