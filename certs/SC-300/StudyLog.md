# Study Log — SC-300: Microsoft Identity and Access Administrator

This log tracks individual study sessions for the **SC-300** exam. Fill in **End**, **Duration**, and **Notes** when the session concludes.
...
|:--|:-----|:------|:----|:---------|:-----|:------|:------|
| 10 | 4/28/26 | 4:02 AM | 6:36 AM | 2h 34m | NotebookLM | Plan and implement entitlement management in Microsoft Entra | Exam tasks completed:
  - Plan entitlements
  - Create and configure catalogs

Next session: Pick up at "Create and configure access packages" |
