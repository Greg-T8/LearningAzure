...
- [Slide 86: Large Customer Migration – HCX Lessons learned](#slide-86-large-customer-migration-hcx-lessons-learned)
...
- [Slide 93: AVS Observability – Host Metrics](#slide-93-avs-observability-host-metrics)
- [Slide 94: AVS Observability – Activity Log Alerts](#slide-94-avs-observability-activity-log-alerts)
- [Slide 95: AVS Observability – VM Guest Monitoring](#slide-95-avs-observability-vm-guest-monitoring)
- [Slide 96: AVS Observability – VMWare Control Plane](#slide-96-avs-observability-vmware-control-plane)
- [Slide 97: AVS Observability – Application Monitoring](#slide-97-avs-observability-application-monitoring)
- [Slide 98: AVS Observability – Azure Services](#slide-98-avs-observability-azure-services)
- [Slide 99: AVS Observability – Syslog](#slide-99-avs-observability-syslog)
...
- The company’s official birthday is in April 2026.
...
- **Upcoming Anniversary**: Microsoft’s 51st anniversary is approaching in April 2026, marking over half a century since its founding.
- **Speaker’s Opinion on Logo**: The presenter expressed a personal view that the latest Microsoft logo is probably the best iteration to date, implying a positive reception of the current branding.
...
- **Tone and Engagement**: The speaker uses a friendly and informal tone, even humorously inviting attendees to send chocolates and flowers for the company’s birthday, which helps create a welcoming atmosphere.

### Definitions

- **Micro-Soft**: The original name of Microsoft at its founding, highlighting the company’s early identity before evolving into the global brand known today.
...
- The company’s birthday is in April, a milestone that underscores its longevity and evolution.
...
- Day 3’s agenda includes sessions on modernizing, securing, and optimizing AVS workloads, storage expansion, and lessons learned.
...
- **Day 3 Sessions:**
  - **8:00 – 9:00 a.m.:** "Modernize, Secure and Optimize AVS Workloads and Operations with Azure Services" presented by Husam Hilal.
  - **9:00 – 10:00 a.m.:** "Storage Expansion Options for Optimizing Azure VMware Solution (AVS) Private Clouds" by Carl Solazzo and Scott Gruenemeier.
  - **10:00 – 10:15 a.m.:** Break.
  - **10:15 – 11:00 a.m.:** "Azure VMware Solution (AVS) Lessons Learned: Designing, Migrating and Operating" by Jon Chancellor and Sabine Blair.
...
- **Speaker’s Context:**
  ...
  - Day 3 will start shortly with Husam Hilal’s presentation.
...
- **NSX Architecture:** VMware’s network virtualization and security platform, critical for AVS networking.
- **Cloud Economics:** The financial and business considerations involved in adopting cloud services like AVS.

### Examples

- No specific practical examples or demonstrations were mentioned in the speaker’s narration or on the slide.

### Key Takeaways 🎯

- The event is structured over three days with clear focus areas: sales and technical deep dives.
- Day 3’s agenda includes important sessions on optimizing AVS workloads, expanding storage, and lessons learned from real-world AVS deployments.
...
- **Session Schedule:**
  - **8:00 – 9:00 a.m.:** "Modernize, Secure and Optimize AVS Workloads and Operations with Azure Services" presented by Husam Hilal. This session likely covers how to leverage Azure services to enhance AVS workloads in terms of modernization, security, and operational efficiency.
  - **9:00 – 10:00 a.m.:** "Storage Expansion Options for Optimizing Azure VMware Solution (AVS) Private Clouds" presented by Carl Solazzo and Scott Gruenemeier. This session focuses on storage strategies to optimize AVS private cloud environments.
  - **10:00 – 10:15 a.m.:** Break.
  - **10:15 – 11:00 a.m.:** "Azure VMware Solution (AVS) Lessons Learned: Designing, Migrating and Operating" presented by Jon Chancellor and Sabine Blair. This session shares practical insights and lessons from real-world AVS deployments.
...
- **Azure VMware Solution (AVS):** A Microsoft Azure service that enables customers to run VMware workloads natively on Azure infrastructure, combining VMware’s virtualization technology with Azure’s cloud capabilities.
...
- No specific technical examples or demonstrations were mentioned in this slide or the speaker’s narration.

### Key Takeaways 🎯

- The day’s technical sessions focus on enhancing and optimizing Azure VMware Solution workloads through modernization, security, storage expansion, and operational best practices.
...
- No specific practical examples or demonstrations were provided on this slide or in the narration. The speaker’s humorous mention of pets and birthday presents was a light-hearted aside rather than a practical example.
...
- Sales badges will be awarded within five days—share them proudly on social media.  
...
- Hussam Hilal’s role as a Partner Solution Architect at Microsoft.
...
- Hussam expresses enthusiasm and gratitude for the attendees’ participation, setting a positive tone for the session.

### Definitions

- **AVS (Azure VMware Solution)**: Although not explicitly defined in this slide or narration, AVS generally refers to Microsoft’s service that allows running VMware workloads natively on Azure infrastructure.
...
- The phrase “very close to my heart” suggests a personal and professional passion for AVS and its modernization journey.
...
- Next, the session covers **Manage workloads with Arc**, demonstrating how Azure Arc can be used to integrate and manage AVS workloads within Azure’s management framework.
...
- The agenda then moves to **Private Connectivity – Attaching to Azure**, explaining how to securely connect AVS environments to Azure services, ensuring secure and reliable communication.
...
- The speaker emphasizes that the current session (the first hour of the AVS bootcamp) will concentrate on stage five — the modernization motivations and how Azure services can be leveraged alongside AVS workloads.
- This stage is critical because it enables customers to extend and enhance their migrated applications by utilizing Azure’s native capabilities, thus achieving modernization beyond simple migration.
...
- This step enables customers to leverage Azure’s cloud-native capabilities to enhance their existing VMware workloads.

---

## Slide 10: Efficiently migrate while maintaining operational consistency

**Timestamp**: 00:04:26 – 00:13:41
...
- **Private Connectivity:**
  - **Private Endpoints** create network adapters with private IP addresses for Azure services (e.g., Storage, SQL, OpenAI), allowing AVS VMs to communicate securely within Azure’s private network.
...
- **External Access and Security:**
  ...
  - This setup is demonstrated in one of the presentation’s demos.
...
- Configuring Application Gateway’s backend pool with AVS VM IP addresses to securely route external traffic to AVS-hosted applications.
...
- This slide highlights common integration examples but is not exhaustive—AVS supports integration with over 200 Azure services.

---

## Slide 13: How AVS integrates with other Azure services

**Timestamp**: 00:25:58 – 00:26:28
...
- **Defender for Cloud**: Azure’s security management and threat protection service for cloud workloads.
...
- **ExpressRoute**: A service that provides a private connection between an organization’s on-premises infrastructure and Azure datacenters.
...
- **Integration with Azure VMware Solution (AVS)**  
  ...
  - This integration ensures that customers benefit from Azure’s native security capabilities while running hybrid or VMware-based workloads.

### Definitions

- **Microsoft Entra ID**: Azure’s identity and access management service that provides identity protection features to secure user authentication and authorization.  
...
- The speaker emphasizes starting with the operational aspect—how to improve and streamline operations by running workflows on AVS after enabling Azure Arc.
...
- The integration bridges VMware environments with Azure’s native cloud management capabilities.
...
- This approach allows IT teams to manage diverse infrastructure and workloads from a **single pane of glass**—the Azure portal or Azure Resource Manager interface.
...
- **Security Integration with Defender for Cloud**:  
  Customers can leverage Microsoft Defender for Cloud to protect VMware workloads by first Arc-enabling their VMware environments. This integration extends Azure’s security capabilities to non-Azure environments.
...
- **Azure Arc’s Role**:  
  Azure Arc acts as an extension of Azure management and security capabilities to resources that are outside of Azure’s native cloud environment. This includes multicloud environments, on-premises datacenters, and hosted environments like AVS. By "Arc-enabling" these resources, they become manageable and securable through Azure tools.

- **Single Control Plane**:  
  Azure Arc provides a unified control plane that allows administrators to manage and secure any resource, regardless of where it is located—on-premises, in other clouds, or in hosted environments. This simplifies governance and security operations.

- **Integration with Defender for Cloud**:  
  Once AVS is Arc-enabled, it can be integrated with Microsoft Defender for Cloud. This integration enables the application of Defender’s security policies, threat detection, and compliance monitoring to AVS workloads, providing consistent security posture management.
...
- Azure Arc enables extending Azure’s management and security capabilities to AVS and other non-Azure environments.
...
- Microsoft’s AI services come with built-in controls to ensure:
...
- Azure AI services provide powerful tools to infuse AI into applications, supported by Microsoft’s commitment to ethical AI principles.
...
- The bank’s clients were unhappy with the legacy applications.
...
- This method enhances security by blocking data exfiltration and ensuring all communication stays within Azure’s private network.
...
- The speaker’s example of an OpenAI service with a private endpoint enabled:  
  - The private endpoint has a network interface with a private IP (e.g., 10.1.3.8).  
  - This IP is registered in the private DNS zone with the resource’s fully qualified domain name (FQDN).  
...
- **Virtual Network Peering**:  
  ...
  - Enhanced security since traffic remains within Azure’s backbone network.  
...
- **Speaker’s Additional Context on Modernization**:  
...
- **Azure Private Endpoint**: A special network interface that connects an Azure PaaS resource privately to your virtual network by assigning it a private IP address from your virtual network’s address space, enabling secure and private connectivity.
...
- **Speaker’s Demo Explanation**:  
  ...
  - The application’s connection string was updated to use the SQL Managed Instance’s hostname, allowing the application to connect privately without code changes.  
...
- **From VM running in AVS (Azure VMware Solution)**:  
  When a VM inside AVS attempts to connect to an Azure Storage Account, the DNS query returns a **private IP address**. This is because the VM’s DNS resolution path is configured to use private DNS zones linked to the virtual network, enabling private endpoint resolution.
...
- The speaker’s example focused on a VM inside AVS querying a SQL Managed Instance:  
...
- AVS workloads’ databases can be modernized by moving data into Azure services.
...
- The example centers on a bank that has migrated its infrastructure to Azure VMware Solution (AVS).
  - The bank’s clients were dissatisfied with the legacy applications.
...
- This integration demonstrates how legacy systems can be modernized by combining AVS infrastructure with Azure’s AI and security features.
...
- Azure’s identity controls facilitate seamless and confident authentication.
- The integration of migration, modernization, and secure connectivity supports unlimited innovation using Azure’s cutting-edge technology.
...
- **Modernizing Client Applications**: The bank’s clients were dissatisfied with the outdated user experience of their applications. To address this, the bank is modernizing these apps by integrating Azure-native capabilities, such as AI, to elevate the user experience.
...
- **Confident Access**: Authentication is managed seamlessly through Azure’s identity controls, specifically using **managed identity**. This allows secure, passwordless authentication for applications and services, enhancing security and simplifying access management.
...
- The slide emphasizes the broader theme of **unlimited innovation** by combining migration and integration with Azure’s cutting-edge technology stack.
...
- The bank’s clients were experiencing poor user experience with legacy applications, prompting modernization using AI-powered Azure-native capabilities.
- The bank uses private endpoints to securely connect to over 200 Azure native services.
- Authentication for the bank’s applications is handled through Azure’s managed identity, ensuring secure and seamless access.
...
- Azure’s managed identity simplifies and secures authentication processes.
...
- **Security and Access Control**  
  - The Arc-enabled VM’s managed identity is assigned appropriate Azure RBAC roles to access cognitive services.  
  - The AI Foundry service’s networking configuration disables all public access, enforcing private endpoint-only connectivity.  
...
- DNS resolution example:  
  ...
  - DNS VM forwards to DNS Private Resolver → Azure Platform DNS → Private DNS Zone.  
...
- Start your AVS learning journey using Microsoft’s free resources: documentation, learning paths, demos, and landing zone guidance.
...
- **AVS (Azure VMware Solution)**: A Microsoft service that enables running VMware workloads natively on Azure infrastructure, combining VMware’s virtualization technology with Azure’s cloud capabilities.
...
- This foundational understanding is important as the presentation moves into discussing **external storage options** for AVS, which complement or extend the host’s native storage capabilities.
...
- AVS plays a critical role in Microsoft’s cloud migration strategy.
...
- **Strategic Importance:**
  - AVS is a key component of Microsoft’s cloud migration strategy, enabling enterprises to move VMware-based workloads to Azure seamlessly.
  - The solution supports hybrid cloud scenarios and modernization efforts by leveraging Azure’s global infrastructure.
...
- The speaker specifically mentioned the addition of four new AVS regions in the last year as practical examples of Microsoft’s expansion efforts:  
  - Spain Central  
  - Norway East  
  - Korea Central  
  - Malaysia West
...
- Being a first-party offering, AVS benefits from Microsoft’s direct ownership, operation, and support, ensuring high service quality and integration.

---

## Slide 45: AVS SKUs & Hardware Details

**Timestamp**: 01:04:48 – 01:05:50
...
- **vSAN (Virtual SAN)**: VMware’s software-defined storage solution that aggregates local storage devices across hosts into a shared datastore.
...
- The session’s focus is on AVS storage capabilities and how to extend them beyond the built-in vSAN storage.

---

## Slide 46: AVS Primary Storage: VMware vSAN

**Timestamp**: 01:05:50 – 01:06:51
...
- **External Storage Integrations**:  
  While vSAN provides robust local storage, there are scenarios where external storage is needed—either to add advanced capabilities or to scale storage without adding more ESXi nodes. Supported external storage options include:  
...
- **ESXi Host**: A physical server running VMware’s hypervisor, which hosts virtual machines and local storage resources.

- **NSX**: VMware’s network virtualization and security platform integrated into the VMware technology stack.
...
- ESA’s elimination of disk groups leads to improved resilience and faster rebuilds.
...
- Customers’ storage demands typically grow faster than compute needs.
...
- **Speaker’s Context and Insights**  
  - The speaker emphasized that in real-world sizing scenarios for AVS, storage rarely fits neatly into predefined “t-shirt” sizes aligned with CPU and compute resources. Storage is almost always the limiting factor.  
  - Customers’ storage needs continually grow, making flexible external storage essential.  
...
- The speaker referenced sizing hundreds of AVS deployments and noted that in almost all cases, storage requirements did not align perfectly with compute sizing “t-shirt” categories, highlighting the need for flexible external storage.
...
- Azure’s storage ecosystem includes native Azure services and marketplace third-party services.
...
- **Customer Preference and Choice**: The speaker highlights that customers tend to stick with storage technologies they know and trust from their on-premises environments. This human tendency is acknowledged by Azure’s approach to offering multiple storage options.
...
- **VMware Cloud Foundation Integration**:
  ...
  - **vSAN**: VMware’s software-defined storage solution integrated for storage management.
...
- Elastic SAN (eSAN) is highlighted as a flexible, low-cost storage tier with independent capacity scaling, similar in concept to Azure NetApp Files’ flexible tier.
...
- **Elastic SAN (eSAN):** A low-cost, flexible storage solution that allows independent scaling of storage capacity, similar in concept to Azure NetApp Files’ flexible tier, optimized for Azure VMware Solution.
...
- Azure NetApp Files provides four service levels—Standard, Premium, Ultra, and Flexible—each optimized for specific workload types and performance needs.
...
- Elastic SAN (eSAN) is another flexible, low-cost storage option supporting independent capacity scaling, reinforcing Azure’s commitment to flexible storage solutions.

---

## Slide 56: Classified as Microsoft Confidential

**Timestamp**: 01:23:29 – 01:24:34
...
- **Speaker’s Additional Insights:**
  ...
  - **Ultra Gateway Costs:** ExpressRoute Ultra Gateway required for connectivity adds roughly $1,100–$1,200/month depending on region.
...
- **Elastic SAN (ESAN):** Azure’s block storage service designed for high-performance, scalable storage that can be used as external storage for AVS.
- **Private Endpoint:** A network interface that connects you privately and securely to a service powered by Azure Private Link.
...
- **Azure NetApp Files Service Levels**: The slide outlines four main service levels, each with distinct characteristics:
  ...
  4. **Flexible Service Level (Customizable)**
     ...
     - Throughput: 128 MiB/s + (0–640) MiB/s per 1 TiB provisioned
...
- This setup enables users to "point and shoot" — simply select ANF as a storage target — and start moving virtual machines off their existing **vSAN** (VMware’s native storage solution) onto Azure’s native, high-performance storage platform.
- The speaker highlights that this approach effectively extends the AVS platform’s storage capabilities by integrating with Azure’s cloud-native storage services.
...
- **vSAN**: VMware’s software-defined storage solution that pools local storage devices in a vSphere cluster to create a shared datastore.
...
- **Customer & Context**: Home Trust Company, a large financial insurance firm with 1,000–9,999 employees, needed to exit its datacenter. The upgrade project was costly and time-consuming, prompting a search for a managed VMware solution that would increase reliability and resilience while reducing operating costs.
...
- **Speaker’s Additional Context**:
  ...
  - This insight aligns with Home Trust’s choice to eliminate 30 AVS nodes dedicated to storage by leveraging Azure NetApp Files.
...
- Home Trust Company’s elimination of 30 AVS nodes dedicated to storage by using Azure NetApp Files as the datastore, resulting in significant cost savings.
...
- **Azure Elastic SAN (ESAN) for AVS** refers to the use of Azure’s Elastic SAN storage service in conjunction with Azure VMware Solution environments.
...
- **Azure VMware Solution (AVS)**: A Microsoft Azure service that allows customers to run VMware workloads natively on Azure infrastructure.
- **vSAN storage**: VMware’s software-defined storage solution that pools direct-attached storage devices across a VMware cluster to create a shared datastore.

### Examples

- The speaker’s example compares two configurations for a workload:
...
- It offers substantial cost savings—up to 52% over three years—while providing a fully managed, hosted storage solution.
...
- Usage of Azure native storage, including Elastic SAN, counts against a customer’s Microsoft Azure Consumption Commitment (MAC), which can provide cost benefits.
...
- **Microsoft Azure Consumption Commitment (MAC)**:  
  The speaker highlights that any usage or purchase of Azure native storage, including Azure Elastic SAN, counts against a customer’s MAC.  
  - **MAC Definition**: A Microsoft Azure Consumption Commitment is a customer’s contractual commitment to spend a certain amount on Azure services over a defined period (typically 3 to 5 years).  
...
- **VMware NSX**: VMware’s network virtualization and security platform, used here to manage networking for VMs in AVS.
- **Azure VMware Solution (AVS)**: A Microsoft Azure service that enables running VMware workloads natively on Azure infrastructure.
...
- The slide’s diagram shows multiple Azure Elastic SAN volumes attached to VMware ESXi hosts and managed via vCenter, illustrating a typical AVS deployment architecture.
...
- Usage of Azure Elastic SAN contributes to a customer’s MAC, potentially lowering costs for committed Azure spenders.
...
- It offers significant cost savings—up to 55% compared to scaling by adding more nodes.
...
- Storage for Azure Native Pure Storage is fully managed by Microsoft and counts toward the customer’s Microsoft Azure Commitment (MAC), ensuring financial efficiency.
...
- The speaker emphasized the financial benefits of using Azure Native Pure Storage, highlighting that all storage is managed by Microsoft and that expenditures on Azure Native Pure Storage count toward the customer’s **Microsoft Azure Commitment (MAC)**. This means any dollar spent reduces the MAC commitment, aligning with customers’ financial goals.
...
- **Connection and Path Configuration:**
  ...
  - Total sessions = (number of paths) × (number of hosts).
...
- **Elastic SAN:** Azure’s scalable, high-performance storage service designed for SAN workloads, supporting multiple sessions and paths.
...
- For example, with 8 paths and 16 hosts, the total number of sessions to the Elastic SAN datastore would be 128 (8 paths × 16 hosts), which is the maximum session limit per volume.
...
- **Speaker’s Explanation on Replication and Disaster Recovery**:
  - Traditional replication tools like Pure Storage’s replication or NetApp’s SnapMirror are platform-specific and do not work across different storage vendors.
  - VMware’s Live Site Recovery (formerly SRM) now supports replication to external storage, including Azure Elastic SAN, ANF (Azure NetApp Files), and Pure Storage.
...
- VMware Live Site Recovery’s support for external storage replication enables flexible, cost-effective DR solutions using Azure Elastic SAN.
...
- **Speaker’s Context:**
  - The speaker and co-presenter express enthusiasm about AVS’s ability to leverage cloud benefits such as cost efficiency and dynamic hardware utilization.
...
- **Elastic SAN (ESAN)**: Azure’s scalable, high-performance storage solution designed to support demanding workloads such as those running on AVS.
...
- The slide’s pricing example uses 65 TB of data transferred outbound and inbound between AVS private cloud and PE, illustrating how data transfer costs accumulate.
...
- The speaker’s narration introduces the next presenters, Sabine and John, who are part of the **Cloud Solutions Unit (CSU)**. This division focuses on:
...
- **Elastic SAN (ESAN)**: Azure’s scalable, high-performance software-defined storage solution designed to provide block storage for AVS.
...
- **Speaker Context:**
  ...
  - Microsoft provides Azure landing zone accelerators—modular, GitHub-based deployment templates—to help customers quickly establish the necessary Azure environment for AVS.
...
- **vSAN**: VMware’s software-defined storage solution that aggregates local storage from multiple hosts into a shared datastore, requiring additional compute nodes.
...
- RaceTrac’s use case: They required more storage capacity than compute for disaster recovery. By switching from vSAN to Azure Elastic SAN, they avoided buying costly compute nodes and reduced storage costs by 30%.
- Microsoft’s Azure landing zone accelerator helps new AVS customers quickly deploy the necessary Azure infrastructure, including modules for migration (HCX), external storage, and monitoring.
...
- RaceTrac’s adoption of Elastic SAN resulted in a 30% cost reduction compared to vSAN.
- Many AVS customers are new to Azure and benefit from Microsoft’s modular Azure landing zone accelerators to speed up deployment and migration.
...
**Timestamp**: 02:16:34 – 02:17:04

![Slide 75](2026_AVS_Bootcamp_Day_3_Notes_images/slide_075.png)

### Key Points

- Overview of Pure Storage’s Cloud Product Family offerings that are generally available.
...
- **Pure Cloud Block Store for AVS** (Azure VMware Solution) is available via a 3rd party marketplace, enabling customers running VMware workloads on Azure to leverage Pure Storage’s block storage capabilities.
...
- Pure Cloud Block Store for AVS supports VMware workloads on Azure, expanding Pure Storage’s cloud footprint.
...
- **Integration with VMware**:  
  CBS supports VMware-certified hardware and integrates seamlessly with VMware vCenter, allowing management of virtual machines (VMs) and ESXi hosts. It supports VMFS datastores, which are VMware’s file systems for storing VM files on block storage devices. The VMware technology stack includes storage via vSAN and networking via NSX, with CBS acting as a certified datastore within this environment.
...
- It integrates tightly with VMware environments, supporting VMFS datastores on ESXi hosts and leveraging VMware’s technology stack.
...
- **vSphere**: VMware’s cloud computing virtualization platform used to manage virtualized environments.
...
- **Cost Efficiency**: The primary driver for adopting this solution is the anticipated significant reduction in Azure storage costs. By leveraging Pure Storage’s native integration with Azure and AVS, Dupaco expects to achieve better storage efficiency and cost management.

- **Operational Benefits**: The fully-managed nature of the Pure Storage Cloud on AVS means Dupaco’s IT team can reduce time spent on managing storage infrastructure. This shift allows the team to redirect focus toward innovation and strategic initiatives rather than operational maintenance.
...
- Dupaco’s use case demonstrates how a financial services organization can leverage AVS combined with Pure Storage to reduce cloud storage costs while simplifying infrastructure management.
...
- Emphasis on understanding AVS’s role and enhancements in cloud infrastructure.
...
- Although no narration was provided, the slide sets the stage for a detailed discussion on AVS’s key features and any new capabilities that have been introduced.
...
- **AVS (Azure VMware Solution)**: A Microsoft Azure service that allows organizations to run VMware workloads on Azure infrastructure, providing a hybrid cloud environment that combines VMware’s virtualization technology with Azure’s cloud capabilities.
...
- This slide introduces the topic of AVS’s key features and new capabilities.
...
- **Agenda Overview**: The slide outlines the session’s focus areas:
...
- Microsoft’s Azure landing zone accelerator simplifies and accelerates the creation of this foundational environment.
...
## Slide 86: Large Customer Migration – HCX Lessons learned

**Timestamp**: 02:11:10 – 02:11:46
...
- **NSX**: VMware’s network virtualization and security platform that provides networking and security services in virtualized environments.
...
- **New to AVS Customers (with Azure Landing Zone):**
  ...
  - They can use **accelerator modules** to deploy add-ons such as:
    - **HCX** (Hybrid Cloud Extension) – primary migration tool for workload mobility.
    - **SRM** (Site Recovery Manager) – for disaster recovery.
...
- Accelerators are essential tools that help customers at different stages—whether new to Azure, new to AVS, or upgrading to Gen 2—quickly and efficiently deploy the necessary infrastructure.
...
- Gen 2 AVS’s VNet integration offers the simplest path for customers with existing Azure network architectures.
...
- Proper DNS forwarding rules to the private DNS resolver’s inbound endpoint are essential for external name resolution.
...
- Monitoring host CPU consumption helps in capacity planning—scaling out or scaling down nodes based on workload demands.
...
- **Speaker’s Emphasis on Host Metrics**:
...
## Slide 93: AVS Observability – Host Metrics

**Timestamp**: 02:32:38 – 02:34:49
...
## Slide 94: AVS Observability – Activity Log Alerts

**Timestamp**: 02:34:49 – 02:38:50
...
- **Activity Log Alerts Overview**  
  Activity Log Alerts are a critical but often underutilized feature for AVS observability. They derive from Azure’s activity log and provide notifications about the health and status of Azure services and resources.
...
- **Activity Log Alerts**: Notifications generated from Azure’s activity log that inform about resource health, service health, and administrative actions related to Azure services and resources.
...
- **Azure Monitor**: Azure’s platform service used to configure and manage alerts based on resource and service health events.
...
## Slide 95: AVS Observability – VM Guest Monitoring

**Timestamp**: 02:38:50 – 02:41:16
...
- **Defender for Cloud:** Azure’s cloud security posture management and threat protection service.
...
## Slide 96: AVS Observability – VMWare Control Plane

**Timestamp**: 02:41:16 – 02:43:13
...
## Slide 97: AVS Observability – Application Monitoring

**Timestamp**: 02:43:13 – 02:43:49
...
## Slide 98: AVS Observability – Azure Services

**Timestamp**: 02:43:49 – 02:47:10
...
- **ESAN (Elastic SAN)**: Azure’s elastic block storage service designed for scalable, high-performance storage.
...
## Slide 99: AVS Observability – Syslog

**Timestamp**: 02:47:10 – 02:48:57
...
- The speaker highlights the quality and breadth of topics and the contributions of many speakers, emphasizing the event’s value.
...
- **Conference Agenda Overview:**
  - **Day 1 (Sales Focus):**
    - 8:00 – 9:00 a.m.: Welcome and Keynote by Christophe Herrbach and Kirsten Megahan.
    - 9:00 – 10:00 a.m.: Azure VMware Solution (AVS) Cloud Economics with Greg Kaffenberger and Scott Gruenemeier.
    - 10:00 – 10:15 a.m.: Break.
    - 10:15 – 11:00 a.m.: Partnering with Microsoft – Incentives and Offers by Lisa James.
    - 11:00 – 11:45 a.m.: Sales Execution and Assessments with Sean Cattanach, Kalpan Raval, and Lue Hale.

  - **Day 2 (Technical Focus):**
    - 8:00 – 9:00 a.m.: Accelerate VMware Modernization While Reducing Risk and Cost by Trevor Davis and Carlos Villuendas.
    - 9:00 – 10:00 a.m.: AVS: Key Features and New Capabilities by Sundeep Hiranandaney and Natalia Jiménez.
    - 10:00 – 10:15 a.m.: Break.
    - 10:15 – 11:00 a.m.: Azure VMware Solution (AVS) Networking: NSX Architecture by Victor Sandoval, Daniel Ribeiro, and Nehali Neogi.
    - 11:00 – 12:00 p.m.: AVS Migration Strategy and Planning with HCX by Dennis Boeynaems.

  - **Day 3 (Technical Focus):**
    - 8:00 – 9:00 a.m.: Modernize, Secure and Optimize AVS Workloads and Operations with Azure Services by Husam Hilal.
    - 9:00 – 10:00 a.m.: Storage Expansion Options for Optimizing AVS Private Clouds by Carl Solazzo and Scott Gruenemeier.
    - 10:00 – 10:15 a.m.: Break.
    - 10:15 – 11:00 a.m.: Azure VMware Solution (AVS) Lessons Learned: Designing, Migrating and Operating by Jon Chancellor and Sabine Blair.

- **Speaker’s Insights on Monitoring and Alerting:**
...
- **Contextual Relationship:**
  ...
  - The speaker’s focus on monitoring and alerting complements the technical sessions by addressing operational best practices and cost management in AVS environments.
...
- The closing remarks reinforced that the event was complete and expressed appreciation for the audience’s time and attention.
